...
## Project Structure
    ...
    ├── withered_block_dev_80785  # Django project configurations
...
1. Clone this repo and `cd withered_block_dev_80785`
...
2. Clone this repo and `cd withered_block_dev_80785`
