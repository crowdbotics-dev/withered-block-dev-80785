"""
Django settings for withered_block_dev_80785 project.
...
ROOT_URLCONF = 'withered_block_dev_80785.urls'
...
WSGI_APPLICATION = 'withered_block_dev_80785.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_block_dev_80785 API",
    "DESCRIPTION": "API documentation for withered_block_dev_80785 App",
    "VERSION": "v1",
}
